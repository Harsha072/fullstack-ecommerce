pipeline {
    ...
    stages {
        ...
        //             def deployStatus = sh(script: "aws cloudformation deploy --template-file template.yml --stack-name your-stack-name --parameter-overrides DockerImageURI=${imageUri} --region us-east-1", returnStatus: true)
